...
export default function TablePartTab() {
    ...
    return <div id="products" className="tab-pane row">
        ...
        <>
            {
                productGroupState.productGroup.priceGroupId === null || productGroupState.priceGroupWasChanged
                    ? <div>Вы изменили продуктовую группу, чтобы продолжить работу с данным блоком сохраните изменения</div>
                    : <>

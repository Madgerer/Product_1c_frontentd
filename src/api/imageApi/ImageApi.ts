...
import {IImage, IImageType, IProductIdentity} from "../../domain/types";
...
export default class ImageApi extends BaseApi {
    ...
    uploadImage = (args: {productGroupId: string, imageType: number, image: File}): Promise<IApplicationResponse<void>> =>
        this.sendQuery<void>('/api/images', args, actionTypes.postFile, true);
